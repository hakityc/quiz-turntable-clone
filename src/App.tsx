  ...
  if (step === 'quiz') {
    return (
      ...
      >
        ...
        >
          Responda às perguntas e<br />entre no processo de ganhar<br />dinheiro
        </div>
        ...
        <div style={{
          ...
          {/* 进度 */}
          <div style={{
            position: 'absolute', right: 20, top: 18, fontSize: 20, color: '#fff8', fontWeight: 500,
          }}>
            1/1
          </div>
          {/* 问题 */}
          <div style={{
            fontSize: 32, fontWeight: 500, marginBottom: 32, marginRight: 60, color: '#fff'
          }}>
            {QUESTION.text}
          </div>
          {/* 选项 */}
...
function TurntablePage() {
  ...
  // sprite帧动画: 10帧，一帧157px。每90ms切一帧
  ...
  return (
    ...
    >
      ...
      <img
        ...
        alt="bg"
        style={{
          position: 'absolute', top: 0, left: 0, width: '100vw', height: '100dvh', objectFit: 'cover', zIndex: 0,
        }}
      />
      <div style={{ zIndex: 1, marginTop: 74, position: 'relative' }}>
        ...
        >
          ...
          <div style={{
            ...
            width: 330,
            height: 330,
            transform: `translate(-20%,-20%) rotate(${currentWheelDeg}deg)`,
              ...
              return (
                <img
                  ...
                  style={{
                    ...
                    width: 74,
                    height: 74,
                    transform: `translate(-50%,-50%) rotate(${deg}deg) translateY(-120px) rotate(${-deg}deg)`,
          ...
          <div style={{
            ...
            fontWeight: 800,
            textAlign: 'center',
            boxShadow: '0 2px 12px #e696f7a9',
            border: '3.2px solid #efaaed',
            zIndex: 9,
            userSelect: 'none',
          }}>{chance}</div>
          ...
          <button
            style={{
              ...
              border: 'none',
              borderRadius: '50%',
              background: 'linear-gradient(145deg, #e09c52 60%, #fff1c9 120%)',
              boxShadow: '0 6px 22px #e19638a9',
              borderBottom: rotating ? 'solid 5px #cfa121' : 'solid 4.2px #b0b825',
          ...
          >
            ...
            {/* sprite动画手，10帧，帧宽约157px，高度为全部高度 */}
            <span
              style={{
                position: 'absolute',
                left: '50%',
            ...
            >
              <span
                style={{
                  display: 'block',
                  width: 1570, /* 10帧Sprite宽度, 图片总宽 */
                  height: 157,
                  background: `url('/hand-sprite.png') 0 0 no-repeat`,
                  backgroundSize: `1570px 157px`,
                  transform: `translateX(-${handFrame * 157}px)`
                }}
              />
            </span>
          </button>
      ...
      {modalOpen && result !== null && (
        ...
        >
          ...
          >
            ...
            <img src={PRIZES[result].img} alt="prize" style={{ width: 83, height: 83, marginBottom: 12 }} />
